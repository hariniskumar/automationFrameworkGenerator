...
import com.cogmento.automation.page.HomePage;
		...
		boolean isElementPDE;
				...
				assertTrue(isElementPDE);
					...
					//Element:login   Type:def
							//[login,def,,xpath,//span[contains(text(),'Log In')]] Type:def
				locator = homePage.getLoginLocator();
				element = homePage.getLogin();
				isElementPDE = homePage.isElementPresentDisplayedAndEnabled(locator, element);
				assertTrue(isElementPDE);
